...
- Use the shared `skill-brick.css` stylesheet for layout, print sizing, cards, placeholders, code blocks, wiring sections, index cards, and Detect/Do theme hooks.
...
- Do not edit files in `microbit/` while that folder is being worked on separately.
